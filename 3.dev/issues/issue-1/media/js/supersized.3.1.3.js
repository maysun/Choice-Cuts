				...
				if (options.navigation){
				    ...
				    if ($('#nextslide').attr('src')){
					    ...
					    $('#nextslide').mousedown(function() {
						   	$(this).attr("src", image_path + "btn-next.jpg");
						});
					...
					if ($('#prevslide').attr('src')){
						...
						$('#prevslide').mousedown(function() {
						    $(this).attr("src", image_path + "btn-back.jpg");
						});
		...
		if (options.keyboard_nav){
			...
			$(document.documentElement).keydown(function (event) {
				...
				if ((event.keyCode == 37) || (event.keyCode == 40)) { //Left Arrow or Down Arrow
					if ($('#prevslide').attr('src')) $('#prevslide').attr("src", image_path + "btn-back.jpg");		//If image, change back button to active
				} else if ((event.keyCode == 39) || (event.keyCode == 38)) { //Right Arrow or Up Arrow
					if ($('#nextslide').attr('src')) $('#nextslide').attr("src", image_path + "btn-next.jpg");	//If image, change next button to active
				}
			...
			$(document.documentElement).keyup(function (event) {
				...
				if ((event.keyCode == 37) || (event.keyCode == 40)) { //Left Arrow or Down Arrow
					...
					if ($('#prevslide').attr('src')) $('#prevslide').attr("src", image_path + "btn-back.jpg");	//If image, change back button to normal
					...
					if ($('#nextslide').attr('src')) $('#nextslide').attr("src", image_path + "btn-next.jpg");	//If image, change next button to normal
